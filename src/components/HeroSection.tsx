  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center ">
        <motion.div
          variants={fadeInUp}
          className="mb-8 px-3 py-2 rounded-full text-xs border-neutral-800"
        >
        ...
        <motion.div variants={fadeInUp} className="mt-6 space-x-4">
          ...
          <a
            href="#"
            className="inline-block border border-neutral-500 hover:bg-neutral-400 transition text-white py-3 px-6 rounded-lg font-medium"
          >
