...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-0 right-0 z-50 m-2">
      {" "}
      <div className="text-neutral-500 bg-black/60 blackdrop-blur-md max-w-7xl mx-auto px-4 py-3 flex justify-between items-center rounded-md border border-neutral-800">
        <a href="#home">
          <img
            src={logo}
            alt="main logo of streamerzz"
            width={120}
            height={24}
          />
        </a>
