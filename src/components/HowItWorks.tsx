  ...
  return (
    <section id="works">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className=" text-3xl lg:text-5xl mt-20 tracking-lighter bg-gradient-to-t from-neutral-50 via-neutral-300 to-neutral-600 bg-clip-text text-transparent ">
